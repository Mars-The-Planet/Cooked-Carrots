...
public class CommonClass {
    ...
    public static final Supplier<Item> COOKED_CARROT = Suppliers.memoize(() -> new Item(new Item.Properties().useItemDescriptionPrefix().setId(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(MOD_ID, "cooked_carrot")))
